public class ChessBoard {
    ...
    public boolean castling7(){
        ...
        if (board[0][4].getSymbol().equals("K") && board[0][7].getSymbol().equals("R") && board[0][5] == null
                && board[0][6] == null) {
            if (board[0][4].getColor().equals("White") && board[0][7].getColor().equals("White") &&
                    board[0][4].check && board[0][7].check && !new King("White").isUnderAttack(this, 0, 6)) {
                board[0][4] = null;
                board[0][7] = null;
            ...
            if (board[7][4].getSymbol().equals("K") && board[7][7].getSymbol().equals("R") && board[7][5] == null
                    && board[7][6] == null) {
                if (board[7][4].getColor().equals("Black") && board[7][7].getColor().equals("Black") &&
                        board[7][4].check && board[7][7].check && !new King("Black").isUnderAttack(this, 7, 6)) {
                    board[7][4] = null;
                    board[7][7] = null;
